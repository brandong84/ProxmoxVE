...
`<OS>-<OS_VERSION>-<NAME>_<APP_VERSION>-<REVISION>_<ARCH>.tar.gz`

Example:

`debian-12-webserver_1.0.0-1_amd64.tar.gz`
...
- All prompts are asked up front before long-running steps to avoid hidden dialogs.
