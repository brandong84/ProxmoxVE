...
# fetch_and_deploy_gh_release "romm" "owner/repo" "tarball"  # Downloads, extracts, tracks version
# fetch_and_deploy_gh_release "romm" "owner/repo" "tarball" "latest" "/opt/romm"
# fetch_and_deploy_gh_release "romm" "owner/repo" "prebuild" "latest" "/opt/romm" "app-*.tar.gz"
#
# --- Tools & Utilities ---
...
# create_self_signed_cert                  # Creates cert in /etc/ssl/romm/
...
ExecStart=/usr/bin/node /opt/romm/server.js
Restart=on-failure
RestartSec=5
